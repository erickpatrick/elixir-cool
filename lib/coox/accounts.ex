defmodule Coox.Accounts do
  ...
  alias Coox.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Coox.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Coox.Accounts.User.password_changeset/3` for a list of supported options.
